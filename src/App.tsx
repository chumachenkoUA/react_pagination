...
export const App: React.FC = () => {
  ...
  const firstVisibleItemNumber = firstItemIndex + 1;
  const lastVisibleItemNumber = Math.min(lastItemIndex, total);
  ...
  return (
    <div className="container">
      ...
      <p className="lead" data-cy="info">
        {`Page ${currentPage} (items ${firstVisibleItemNumber} - ${lastVisibleItemNumber} of ${total})`}
      </p>
